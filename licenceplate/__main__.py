from . import DEFAULT_PATIENCE_IN_SECONDS, DEFAULT_VEHICLE_QUEUE_SIZE, DEFAULT_NUM_VEHICLE_WORKERS, DEFAULT_NUM_LOCAL_STORAGE_WORKERS, DEFAULT_STORAGE_QUEUE_SIZE, Agent
import argparse
...
def main() -> None:
    ...
    parser.add_argument('--patience', metavar='SECONDS', required=False, type=float, default=DEFAULT_PATIENCE_IN_SECONDS, help=f'Tempo, em segundos, para que um veículo que deixou de ser detectado seja reportado (default = {DEFAULT_PATIENCE_IN_SECONDS}).')
    ...
    agent.run(
        ...
        patience_in_seconds=kwargs['patience'],
