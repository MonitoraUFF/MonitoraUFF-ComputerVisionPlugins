...
for filepath in ['data\\dataset\\video - iacs-camera-01 - 2024.06.10 15.59.mp4']: # glob.glob(os.path.join(DATASET_DIR, '*.mp4')): #Debug ['data\\dataset\\video - iacs-camera-01 - 2024.06.10 15.59.mp4']
